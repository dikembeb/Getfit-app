...
<ScrollView style={styles.page} showsVerticalScrollIndicator={false}>
<View style={styles.pageHeader}>
<BB style={{ fontSize:24, letterSpacing:2 }}>TODAYS WORKOUT</BB>
<View style={styles.streakBadge}>
...
```
  ...
  {tab === "progress" && (
    <View>
      <TouchableOpacity style={[styles.btnLime, { alignSelf:"stretch", alignItems:"center", marginBottom:14 }]}>
        <BB style={{ fontSize:14, color:G.black, letterSpacing:1 }}>📸 ADD THIS WEEKS PHOTO</BB>
      </TouchableOpacity>
